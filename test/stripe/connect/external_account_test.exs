defmodule StripeFork.ExternalAccountTest do
  ...
  describe "create/2" do
    test "creates a bank account for an account" do
      {:ok, _} =
        StripeFork.ExternalAccount.create(%{account: "acct_123", token: "tok_stripetestbank"})
  ...
  describe "list/3" do
    ...
    test "lists all bank accounts for an account" do
      {:ok, %StripeFork.List{data: bank_accounts}} =
        StripeFork.ExternalAccount.list(:bank_account, %{account: "acct_123"})
    ...
    test "lists all cards for an account" do
      {:ok, %StripeFork.List{data: cards}} =
        StripeFork.ExternalAccount.list(:card, %{account: "acct_123"})
