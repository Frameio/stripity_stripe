defmodule StripeFork.FeeRefundTest do
  ...
  describe "retrieve/2" do
    test "retrieves a transfer" do
      assert {:ok, %StripeFork.FeeRefund{}} =
               StripeFork.FeeRefund.retrieve("transf_123", "rev_123")
  ...
  describe "list/2" do
    test "lists all appliction_fees refunds" do
      assert {:ok, %StripeFork.List{data: appliction_fees}} =
               StripeFork.FeeRefund.list("transf_123")
