defmodule StripeFork.TransferReversalTest do
  ...
  describe "retrieve/2" do
    test "retrieves a transfer" do
      assert {:ok, %StripeFork.TransferReversal{}} =
               StripeFork.TransferReversal.retrieve("transf_123", "rev_123")
  ...
  describe "create/2" do
    test "creates a transfer" do
      ...
      assert {:ok, %StripeFork.TransferReversal{}} =
               StripeFork.TransferReversal.create("transf_123", params)
  ...
  describe "list/2" do
    test "lists all transfers" do
      assert {:ok, %StripeFork.List{data: transfers}} =
               StripeFork.TransferReversal.list("transf_123")
