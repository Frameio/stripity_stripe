defmodule StripeFork.SourceTest do
  use StripeFork.StripeCase, async: true

  describe "create/2" do
    test "creates a source for a customer" do
      assert {:ok, %StripeFork.Source{}} = StripeFork.Source.create(%{type: "bitcoin"})
  ...
  describe "retrieve/2" do
    test "retrieves a source" do
      assert {:ok, %StripeFork.Source{}} = StripeFork.Source.retrieve("src_123", %{})
  ...
  describe "update/2" do
    test "updates a source" do
      assert {:ok, %StripeFork.Source{}} = StripeFork.Source.update("src_123", %{})
  ...
  describe "attach/2" do
    test "attaches a source to a customer" do
      assert {:ok, %StripeFork.BankAccount{}} =
               StripeFork.Source.attach(%{customer: "cus_123", source: "src_123"})
  ...
  describe "detach/2" do
    test "detaches a source from a customer" do
      assert {:ok, %StripeFork.BankAccount{}} =
               StripeFork.Source.detach("src_123", %{customer: "cus_123"})
