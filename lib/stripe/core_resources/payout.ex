defmodule StripeFork.Payout do
  ...
  @type t :: %__MODULE__{
          ...
          destination:
            StripeFork.id() | StripeFork.Card.t() | StripeFork.BankAccount.t() | String.t() | nil,
        ...
        when params:
               %{
                 ...
                 optional(:destination) =>
                   StripeFork.id() | StripeFork.Card.t() | StripeFork.BankAccount.t() | String.t(),
  ...
  """
  @spec cancel(StripeFork.id() | t, StripeFork.options()) ::
          {:ok, t} | {:error, StripeFork.Error.t()}
