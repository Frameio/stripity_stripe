defmodule StripeFork.FeeRefund do
  ...
  """
  @spec create(StripeFork.id() | t, params, StripeFork.options()) ::
  ...
  """
  @spec retrieve(StripeFork.id() | t, StripeFork.id() | t, StripeFork.options()) ::
          {:ok, t} | {:error, StripeFork.Error.t()}
  ...
  """
  @spec update(StripeFork.id() | t, StripeFork.id() | t, params, StripeFork.options()) ::
          {:ok, t} | {:error, StripeFork.Error.t()}
        when params: %{
               optional(:metadata) => StripeFork.Types.metadata()
             }
  ...
  List all transfers.
  """
  @spec list(StripeFork.id() | t, params, StripeFork.options()) ::
