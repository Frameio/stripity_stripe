defmodule StripeFork.Order do
  ...
  Pay an order.
  """
  @spec pay(StripeFork.id() | t, params, StripeFork.options()) ::
          {:ok, t} | {:error, StripeFork.Error.t()}
        when params: %{
               optional(:application_fee) => non_neg_integer,
               optional(:customer) => StripeFork.id() | StripeFork.Customer.t(),
               optional(:source) =>
                 StripeFork.id() | StripeFork.Card.t() | StripeFork.Customer.t() | card_info,
               optional(:email) => String.t(),
               optional(:metadata) => StripeFork.Types.metadata()
             }
  ...
  return an order.
  """
  @spec return(StripeFork.id() | t, params, StripeFork.options()) ::
          {:ok, t} | {:error, StripeFork.Error.t()}
        when params: %{
               optional(:items) => StripeFork.List.t(StripeFork.OrderItem.t())
             }
